...
public interface DocumentLoader {
	 ...
	 * @param errorHandler used to report any errors during document loading 处理加载document对象的过程产生的错误
	 ...
	 *                                   命名空间支持。如果要提供对xml名称空间的支持，则要设置为true
	 * @return the loaded {@link Document document}  返回加载生成的document对象
